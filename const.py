...
CHAR_SLEEP_NOTIFY_UUID = "00006102-0000-1000-8000-00805f9b34fb"
...
CMD_ID_SLEEP_DATA = 0x1E
SLEEP_FETCH_SUBCMD_INIT = 0x01
SLEEP_FETCH_SUBCMD_END = 0x02
SLEEP_SYNC_RETRY_TIMEOUT_SECONDS = 3
SLEEP_SYNC_MAX_CONSECUTIVE_RETRIES = 3
...
# BLE reconnection backoff (connect / subscribe / initialize)
RECONNECT_INITIAL_DELAY_SECONDS = 2
RECONNECT_MAX_DELAY_SECONDS = 30
RECONNECT_CONNECTED_POLL_SECONDS = 10
RECONNECT_DISCONNECT_PAUSE_SECONDS = 0.5
